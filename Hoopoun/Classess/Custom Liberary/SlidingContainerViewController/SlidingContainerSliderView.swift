...
public class SlidingContainerSliderView: UIScrollView, UIScrollViewDelegate {
  ...
  public init(width: CGFloat, titles: [String]) {
    ...
    appearance = SlidingContainerSliderViewAppearance (
      ...
      selectedFont: UIFont(name: "SFUIText-Bold", size: 14)!,
      textColor: UIColor.gray,
      selectedTextColor: kDefaultColor,
      outerPadding: 10,
      innerPadding: 10,
      selectorColor: kDefaultColor,
      selectorHeight: 5,
      fixedWidth: false)

    let lineView = UIView(frame: CGRect(x: 0, y:40, width: kIphoneWidth , height: 5))
