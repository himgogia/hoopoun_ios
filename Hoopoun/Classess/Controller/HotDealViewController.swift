...
class HotDealViewController: UIViewController,UITableViewDataSource,UITableViewDelegate {
    ...
    @IBOutlet weak var hotDealTable: UITableView!
    
    override func viewDidLoad() {
        super.viewDidLoad()
        
        if hotdealArray.count == 0 {
            messageLabel.isHidden = false
            hotDealTable.isHidden = true
        }
    }
    ...
    func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        ...
        if self.hotdealArray.count>0 {
            cell.setAroundMeCellData(dictionary: self.hotdealArray.object(at: indexPath.section) as! NSMutableDictionary, cellType: "")
        }
    ...
    func tableView(_ tableView: UITableView, heightForRowAt indexPath: IndexPath) -> CGFloat {
        ...
        let dict : NSMutableDictionary =  self.hotdealArray.object(at: indexPath.section) as! NSMutableDictionary
    ...
    func tableView(_ tableView: UITableView, didSelectRowAt indexPath: IndexPath) {
     ...
     /*   if appDelegate.userType == kguestUser {
            ...
            self.getOfferDetails(dict: hotdealArray.object(at: indexPath.section) as! NSMutableDictionary)
       // }
